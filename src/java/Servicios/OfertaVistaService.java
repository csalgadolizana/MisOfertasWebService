...
public class OfertaVistaService {
    ...
    public List<Ofertavisi> ListadoOfertaVisitas() {
        TypedQuery<Ofertavisi> query = em.createNamedQuery("Ofertavisi.findAll", Ofertavisi.class);
        return query.getResultList();
    }

    @WebMethod(operationName = "Crear_oferta_visitas")
    public String CrearOfertaVisitas(
            @WebParam(name = "fecha_vista") Date fecha_vista,
            @WebParam(name = "id_cliente") int id_cliente,
            @WebParam(name = "id_oferta") int id_oferta
    ) {
        try {
